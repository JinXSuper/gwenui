      ...
      >
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1 rounded-lg text-[13px] transition-all cursor-pointer bg-[var(--docs-elem-surface)] hover:bg-[var(--docs-elem-surface-strong)] border border-[var(--docs-border-faint)] hover:border-[var(--docs-border)] text-[var(--docs-text-faint)] hover:text-[var(--docs-text-heading)] h-8 shadow-[var(--shadow-tier-1)]"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 px-4 h-8 rounded-full font-bold text-xs bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_2px_12px_rgba(var(--primary-rgb),0.3)] transition-all hover:scale-[1.04] active:scale-[0.98]"
            style={{
        ...
        <button
          ...
          className="md:hidden flex items-center justify-center p-1.5 rounded-lg text-[var(--muted-foreground)] hover:text-white hover:bg-[var(--hover-glass)] transition-colors cursor-pointer"
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-full font-bold text-sm text-primary-foreground hover:bg-primary/90 shadow-[0_2px_12px_rgba(var(--primary-rgb),0.3)] transition-all"
                style={{
                  backgroundColor: "var(--primary)",
                }}
              >

...
export function BlockViewer({ block, variant = "default" }: BlockViewerProps) {
      ...
      <div className="flex flex-col w-full h-full relative overflow-hidden bg-transparent select-none">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-[var(--docs-card-bg)]/60 rounded-full p-1 border border-[var(--docs-border-strong)] shrink-0 shadow-sm">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[12px] font-medium transition-all duration-200 uppercase tracking-wider ${
                      isActive 
                        ? "bg-[var(--docs-elem-surface-strong)] text-[var(--docs-text-heading)] shadow-sm font-semibold" 
                  ...
                  <>
                    ...
                    <button
                      ...
                      className={`p-1.5 px-3 rounded-full transition-all flex items-center justify-center ${
                        isLandscape
                          ? "text-[var(--docs-text-heading)] bg-[var(--docs-elem-surface-strong)] shadow-sm"
          ...
          <div className="flex items-center gap-3">
            ...
            {activeTab === "preview" && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] font-medium transition-all bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] shadow-sm text-[var(--docs-text-faint)] hover:text-[var(--docs-text-heading)] hover:bg-[var(--docs-elem-hover)]"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-1.5 bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] hover:bg-[var(--docs-elem-surface-strong)] rounded-full text-[11px] font-mono font-bold tracking-wider text-[var(--primary)] transition-all duration-200 shadow-sm"
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isFullscreen && (
          ...
          >
            ...
            <div className="absolute bottom-6 left-10 flex items-center gap-1.5 bg-[var(--docs-elem-surface-strong)]/40 border border-[var(--docs-border-faint)] rounded-full p-1 shadow-2xl backdrop-blur-md z-50">
              {[
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-xs font-medium transition-all duration-200 flex items-center gap-1.5 select-none ${
                      isActive
                        ? "bg-[var(--docs-text-heading)] text-[var(--docs-page-bg)] font-bold shadow-lg"
      ...
      <div className="absolute top-6 left-6 z-40 flex items-center gap-0.5 bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] backdrop-blur-xl rounded-full p-1 shadow-2xl">
        {(["preview", "code"] as const).map((tab) => {
          const isActive = activeTab === tab;
          return (
            <button
      ...
      <div className="flex-1 w-full relative overflow-hidden bg-[var(--docs-page-bg)]/20 flex h-full">
        {activeTab === "preview" ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center p-8 relative overflow-auto pt-24">
            ...
            <div className="absolute top-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-1 bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] backdrop-blur-xl rounded-full p-1 shadow-2xl">
              {[
                { id: "desktop", label: "Desktop", icon: <Monitor className="w-3.5 h-3.5" /> },
                { id: "tablet", label: "Tablet", icon: <Tablet className="w-3.5 h-3.5" /> },
                { id: "mobile", label: "Mobile", icon: <Smartphone className="w-3.5 h-3.5" /> },
            ...
            <div className="absolute top-6 right-6 z-40 flex items-center">
              <button
                onClick={() => copyToClipboard(block.command, "command")}
                className="flex items-center gap-2 px-4 py-2 bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] backdrop-blur-xl rounded-full text-[10px] font-mono font-bold tracking-wider text-[var(--primary)] hover:text-[var(--primary)]/90 transition-all duration-200 shadow-2xl hover:scale-[1.02] active:scale-[0.98]"
              >
                <span>$</span>
                <span>{block.command}</span>
                {copied === "command" ? (
          ...
          <div className="w-full h-full flex overflow-hidden relative">
            ...
            <div className="absolute top-6 right-6 z-40">
              <button
                onClick={() => copyToClipboard(fileContent, "code")}
                className="flex items-center gap-2 px-4 py-2 bg-[var(--docs-card-bg)]/60 border border-[var(--docs-border-strong)] backdrop-blur-xl rounded-full text-[10px] font-bold uppercase tracking-wider text-[var(--docs-text-body)] hover:text-[var(--docs-text-heading)] transition-all duration-200 shadow-2xl hover:scale-[1.02] active:scale-[0.98]"
              >

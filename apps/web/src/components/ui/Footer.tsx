...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "MIT", href: "https://opensource.org/license/mit", external: true },
    { label: "BSL 1.1", href: "https://mariadb.com/bsl11/", external: true },
  ],
  Connect: [
...
export function Footer() {
  return (
    <footer className="relative z-10 w-full border-t py-20 px-6 mt-32"
      style={{
        borderColor: "var(--docs-border-faint)",
        background: "oklch(0.98 0.005 87.47 / 100%)",
      }}
    >
      {/* Subtle top glow */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <p className="text-sm max-w-[260px] leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
                  ...
                  <li key={link.label}>
                    {"external" in link && link.external ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm hover:text-orange-400 transition-colors duration-150 flex items-center gap-1.5 group"
                        style={{ color: "var(--muted-foreground)" }}
                      >
                        {link.label}
                        <svg
                      ...
                      <Link
                        href={link.href}
                        className="text-sm hover:text-orange-400 transition-colors duration-150"
                        style={{ color: "var(--muted-foreground)" }}
                      >
                        {link.label}
                      </Link>
        ...
        {/* Install CTA strip */}
        <div
          className="rounded-xl px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 mb-12"
          style={{
            border: "1px solid var(--docs-border-faint)",
        ...
        >
          ...
          <code
            className="text-sm font-mono px-3 py-1.5 rounded-lg tracking-wide"
            style={{
              color: "var(--primary)",
              background: "oklch(0.72 0.15 48 / 10%)",
        ...
        >
          ...
          <div className="flex items-center gap-1 text-[12px]" style={{ color: "var(--docs-text-faint)" }}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-orange-400 transition-colors ml-1 font-medium"
              style={{ color: "var(--muted-foreground)" }}
            >
              JinXSuper
            </a>

...
export function CodeSnippet({
  ...
  return (
    <div className="flex flex-col w-full my-6">
      ...
      <div className="rounded-xl border border-white/8 overflow-hidden w-full flex flex-col shadow-lg" style={{ background: "hsl(240 10% 6%)" }}>
        
        {/* Header Tab Bar containing segmented switches with dividers */}
        <div className="flex items-center justify-between border-b border-[var(--docs-border-faint)]/80 shrink-0" style={{ background: "hsl(240 10% 8%)" }}>
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-[var(--background)]/45 border-b-2 border-[var(--docs-border-strong)]"
                      transition={{
                        type: "spring",
                        stiffness: 380,
                        damping: 30,
        ...
        <div className="relative group w-full p-5 overflow-hidden" style={{ background: "hsl(240 10% 6%)" }}>
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="font-mono text-xs overflow-auto max-h-[380px] custom-scrollbar w-full"
              style={{ color: "#e2e8f0" }}
            >
              {activeTab.highlightedCode ? (
                activeTab.highlightedCode
              ) : (
                <pre className="whitespace-pre" style={{ color: "#e2e8f0" }}>
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 z-10">
            <button
              ...
              className="p-2 rounded-lg border border-[var(--docs-border-faint)] bg-[var(--docs-card-bg)]/90 hover:bg-[var(--docs-elem-hover)] text-[var(--docs-text-faint)] hover:text-[var(--docs-text-heading)] transition-all duration-200 opacity-60 sm:opacity-0 group-hover:opacity-100 focus:opacity-100 flex items-center justify-center cursor-pointer"
              title="Copy code"
            >

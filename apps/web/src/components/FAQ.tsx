...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Basic blocks are MIT-licensed for personal and commercial use. Supreme blocks are under BSL 1.1. You cannot resell GwenUI blocks or host them as a competing component library.",
  },
  {

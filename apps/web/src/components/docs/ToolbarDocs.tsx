...
export function ToolbarDocs({
  ...
  return (
    <div className="absolute top-8 left-8 right-8 z-50 flex items-center justify-between gap-4 select-none pointer-events-auto">
      ...
      <div className="flex items-center bg-[var(--docs-card-bg)]/60 backdrop-blur-xl rounded-full p-1 border border-[var(--docs-border-strong)] btn-shadow-group shrink-0">
        {[
      ...
      <div className="flex items-center bg-[var(--docs-card-bg)]/60 backdrop-blur-xl rounded-full p-1 border border-[var(--docs-border-strong)] btn-shadow-group">
        {[
          {
            id: "desktop",
            icon: (
      ...
      <button
        ...
        className="flex items-center gap-2.5 px-4 py-1.5 bg-[var(--docs-card-bg)]/60 backdrop-blur-xl rounded-full border border-[var(--docs-border-strong)] btn-shadow transition-all text-[var(--docs-text-faint)] hover:text-[var(--docs-text-heading)] hover:bg-[var(--docs-elem-hover)] shrink-0 z-10"

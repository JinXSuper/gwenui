...
export function CopyPageButton() {
  ...
  return (
    <div ref={dropdownRef} className="relative">
      <div className="btn-shadow-group flex items-center h-8 rounded-md bg-[var(--surface)] border border-[var(--docs-border-faint)] text-[13px] font-medium text-[var(--docs-text-heading)] transition-colors group">
      ...
      <div
        className={`absolute right-0 top-full mt-2 w-44 z-50
                   ...
                   border border-[var(--docs-border-faint)] shadow-[var(--button-shadow)]
      ...
      >
        <button
          onClick={handleCopy}
          className="w-full flex items-center gap-2.5 px-3 py-2.5 shadow-none
